...
const polybiusModule = (function () {
  ...
  function polybius(input, encode = true) {
    ...
    const Symbols =["11","21","31","41","51","12","22",
                    "32","42","52","13","23","33","43",
                    "53","14","24","34","44","54","15",
                    "25","35", "45","55"];
      ...
      for (let text = 0; text < message.length; text++) {
        ...
        if (letter.match(/[a-z]/)) {
          ...
          if (letter === "i" || letter === "j") {
            ...
            let num = Alphabets.indexOf(letter); //look up index of letter
            result += Symbols[num]; //add number with matching index to the code
          }
        } else {
      ...
      for (word of lettersArr) {
        ...
        for (letter of word) {
          if (letter === "42") {
            ...
            let num = Symbols.indexOf(letter);
            let something = Alphabets[num];
